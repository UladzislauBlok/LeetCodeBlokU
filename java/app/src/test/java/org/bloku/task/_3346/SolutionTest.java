...
class SolutionTest {
    ...
    static Stream<Arguments> solutionReturnsExpectedResult() {
        return Stream.of(
                ...
                Arguments.of(
                        new int[] {
                            1, 3, 4, 4, 3, 4, 5, 4, 3, 3, 4, 65, 56, 745, 5634, 56, 4356, 354, 6,
                            3456, 354, 6732, 4657, 4546, 7, 5466, 543, 6745, 67, 4657, 4657, 456,
                            74, 567, 456, 7456, 7, 345, 76547, 87, 2376, 83, 36457, 68746, 7, 5,
                            7665, 53, 654, 73, 45676, 4567, 65, 5, 6, 4, 4, 9
                        },
                        1002,
                        8,
                        15));
