...
class FindSubsequenceLengthKWithLargestSumTest {

    private FindSubsequenceLengthKWithLargestSum solution;

    @BeforeEach
    public void setUp() {
        this.solution = new FindSubsequenceLengthKWithLargestSum();
    }
