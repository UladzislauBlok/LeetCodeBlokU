...
class MergeTwo2DArraysSummingValuesTest {

    private MergeTwo2DArraysSummingValues solution;

    @BeforeEach
    public void setUp() {
        this.solution = new MergeTwo2DArraysSummingValues();
    }

    @ParameterizedTest
    @MethodSource
    void mergeArraysReturnsExpectedResult(int[][] nums1, int[][] nums2, int[][] expected) {
        // given
